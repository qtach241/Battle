...
function Battle:OnPlayerLevelUp(keys)
  ...
  clog.info("Handling event: dota_player_gained_level", "EVENT")
...
function Battle:OnAbilityChannelFinished(keys)
  ...
  clog.info("Handling event: dota_ability_channel_finished", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnPlayerLearnedAbility(keys)
  ...
  clog.info("Handling event: dota_player_learned_ability", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnDisconnect(keys)
  ...
  clog.info("Handling event: player_disconnect: " .. tostring(keys.userid), "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnItemPurchased(keys)
  ...
  clog.info("Handling event: dota_item_purchased", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnItemPickedUp(keys)
  ...
  clog.info("Handling event: dota_item_picked_up", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnLastHit(keys)
  ...
  clog.info("Handling event: last_hit", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnNonPlayerUsedAbility(keys)
  ...
  clog.info("Handling event: dota_non_player_used_ability", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnPlayerChangedName(keys)
  ...
  clog.info("Handling event: player_changename", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnRuneActivated(keys)
  ...
  clog.info("Handling event: dota_rune_activated_server", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnPlayerTakeTowerDamage(keys)
  ...
  clog.info("Handling event: dota_player_take_tower_damage", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnTreeCut(keys)
  ...
  clog.info("Handling event: tree_cut", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnEntityHurt(keys)
  ...
  clog.info("Handling event: entity_hurt", "EVENT")
  DebugPrintTable(keys)
...
function Battle:PlayerConnect(keys)
  ...
  clog.info("Handling event: player_connect", "EVENT")
  DebugPrintTable(keys)
end
...
function Battle:OnAbilityUsed(keys)
  ...
  clog.info("Handling event: dota_player_used_ability", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnPlayerPickHero(keys)
  ...
  clog.info("Handling event: dota_player_pick_hero", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnTeamKillCredit(keys)
  ...
  clog.info("Handling event: dota_team_kill_credit", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnPlayerReconnect(keys)
  ...
  clog.info("Handling event: player_reconnected", "EVENT")
  DebugPrintTable(keys)
end
...
function Battle:OnIllusionsCreated(keys)
  ...
  clog.info("Handling event: dota_illusions_created", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnItemCombined(keys)
  ...
  clog.info("Handling event: dota_item_combined", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnAbilityCastBegins(keys)
  ...
  clog.info("Handling event: dota_player_begin_cast", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnTowerKill(keys)
  ...
  clog.info("Handling event: dota_tower_kill", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnPlayerSelectedCustomTeam(keys)
  ...
  clog.info("Handling event: dota_player_selected_custom_team", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnNPCGoalReached(keys)
  ...
  clog.info("Handling event: dota_npc_goal_reached", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnPlayerChat(keys)
  ...
  clog.info("Handling event: player_chat", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnGameRulesStateChange(keys)
  ...
  clog.info("Handling event: game_rules_state_change", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnNPCSpawned(keys)
  ...
  clog.info("Handling event: npc_spawned", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnEntityKilled(keys)
  ...
  clog.info("Handling event: entity_killed", "EVENT")
  DebugPrintTable(keys)
...
function Battle:OnConnectFull(keys)
  ...
  clog.info("Handling event: player_connect_full", "EVENT")
  DebugPrintTable(keys)
